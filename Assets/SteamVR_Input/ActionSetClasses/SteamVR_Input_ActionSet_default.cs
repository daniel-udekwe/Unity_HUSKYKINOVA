...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Single DPAD_UP
        {
            get
            {
                return SteamVR_Actions.default_DPAD_UP;
            }
        }
        
        public virtual SteamVR_Action_Single DPAD_DOWN
        {
            get
            {
                return SteamVR_Actions.default_DPAD_DOWN;
            }
        }
        
        public virtual SteamVR_Action_Single DPAD_LEFT
        {
            get
            {
                return SteamVR_Actions.default_DPAD_LEFT;
            }
        }
        
        public virtual SteamVR_Action_Single DPAD_RIGHT
        {
            get
            {
                return SteamVR_Actions.default_DPAD_RIGHT;
            }
        }
        
        public virtual SteamVR_Action_Boolean DPAD_CENTER
        {
            get
            {
                return SteamVR_Actions.default_DPAD_CENTER;
            }
        }
